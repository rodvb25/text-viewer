...
G_DEFINE_TYPE(TextViewerApplication, text_viewer_application,
...
TextViewerApplication *text_viewer_application_new(const char *application_id,
  ...
  return g_object_new(TEXT_VIEWER_TYPE_APPLICATION, "application-id",
                      application_id, "flags", flags, NULL);
}

static void text_viewer_application_activate(GApplication *app) {
  GtkWindow *window;
...
static void text_viewer_application_about_action(GSimpleAction *action,
                                                 GVariant *parameter,
                                                 gpointer user_data) {
  ...
  adw_show_about_window(
      window, "application-name", "text-viewer", "application-icon",
      "com.example.TextViewer", "developer-name", "Unknown", "version", "0.1.0",
      "developers", developers, "copyright", "© 2024 Unknown", NULL);
}

static void text_viewer_application_quit_action(GSimpleAction *action,
                                                GVariant *parameter,
                                                gpointer user_data) {
  TextViewerApplication *self = user_data;
...
static void text_viewer_application_init(TextViewerApplication *self) {
